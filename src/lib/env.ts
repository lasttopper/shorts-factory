...
export const ENV_KEYS: EnvKeyDef[] = [
  ...
  { key: "APP_URL", label: "Public app URL", group: "YouTube", placeholder: "https://your-app.example.com", help: "Required for the Google callback; no trailing slash" },
  { key: "YT_CLIENT_ID", label: "Shared Google OAuth client ID", group: "YouTube", secret: true, help: "One Web OAuth client for every user" },
  { key: "YT_CLIENT_SECRET", label: "Shared Google OAuth client secret", group: "YouTube", secret: true, help: "Keep server-side; users never see this" },
  { key: "YT_REFRESH_TOKEN", label: "Legacy global refresh token", group: "YouTube", secret: true, help: "Optional legacy fallback; new users click Connect with YouTube" },
  { key: "YOUTUBE_UPLOAD_ENABLED", label: "Legacy global uploads flag", group: "YouTube", placeholder: "false" },
