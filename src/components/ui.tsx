...
export function StatusChip({ status }: { status: string }) {
  const map: Record<string, string> = {
    ...
    partial: "border-amber-400/60 text-amber-300",
    rendering: "border-[#d4ff3f]/60 text-[#d4ff3f]",
    uploading: "border-[#d4ff3f]/60 text-[#d4ff3f]",
    rendered: "border-violet-400/50 text-violet-300",
    planned: "border-[#39405a] text-[#8b93a7]",
    simulated: "border-[#39405a] text-[#8b93a7]",
